    ...
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            var client = new SmtpClient
            {
                ...
                Credentials = new NetworkCredential("hungdo99tt@gmail.com", "hungduyen2030"),       // Chỉnh email và password gửi đi
                EnableSsl = true,
            };

            var from = new MailAddress("hungdo99tt@gmail.com", "Hưng Đỗ");
