...
namespace PMSShoppingApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        PMSShoppingDBContext _PMSShoppingDbContext = null; 

        public AccountController()
        {
            _PMSShoppingDbContext = new PMSShoppingDBContext();
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //check user
            var checkUser = _PMSShoppingDbContext.AspNetUsers.SingleOrDefault(m => m.Email == model.Email);
            if (checkUser == null)
            {
                ModelState.AddModelError("CustomError", "Tài khoản chưa được đăng ký");
                return View(model);
            }
